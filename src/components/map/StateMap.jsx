...
import { formatMapHint, getRosterCounts } from '../../lib/stateCard.js';
...
export default function StateMap({ mapTopology, features, geoFeatures, cardsByCode, selectedCode, onSelect, discoveredCodes = new Set(), totalStates = 0 }) {
